...
> **作者**: [Previous Agent]
> **日期**: 2026-05-14
> **最后更新**: v10 Agent — Firewalk Toggle重写 + 爆炸碰撞检测统一 + Controls Guide + 导出配置准备
...
22. **✅ Teleport输入修复**：从_process移除，仅保留在_unhandled_input，修复按"2"键无效
...
27. **✅ 游戏导出配置准备**：export_presets.cfg配置加密参数，创建export_game.ps1（尚未实际导出exe）
